...
#include "ristretto/lstm_ristretto_layer.hpp"
...
template <typename Dtype>
void LSTMRistrettoLayer<Dtype>::RecurrentInputBlobNames(vector<string>* names) const {
  names->resize(2);
  (*names)[0] = "h_0";
  (*names)[1] = "c_0";
}
...
template <typename Dtype>
void LSTMRistrettoLayer<Dtype>::RecurrentOutputBlobNames(vector<string>* names) const {
  names->resize(2);
...
template <typename Dtype>
void LSTMRistrettoLayer<Dtype>::RecurrentInputShapes(vector<BlobShape>* shapes) const {
...
template <typename Dtype>
void LSTMRistrettoLayer<Dtype>::OutputBlobNames(vector<string>* names) const {
  names->resize(1);
  (*names)[0] = "h";
}
...
void LSTMRistrettoLayer<Dtype>::FillUnrolledNet(NetParameter* net_param) const {
  ...
  //hidden_param.set_type("InnerProduct"); Edit Here 
  hidden_param.set_type("FcRistretto");
  hidden_param.mutable_inner_product_param()->set_num_output(num_output * 4);
  hidden_param.mutable_inner_product_param()->set_bias_term(false);
  hidden_param.mutable_inner_product_param()->set_axis(2);
  hidden_param.mutable_inner_product_param()->
      mutable_weight_filler()->CopyFrom(weight_filler);
  hidden_param.mutable_quantization_param()->set_fl_params(this->fl_params_);
  hidden_param.mutable_quantization_param()->set_bw_params(this->bw_params_);
  hidden_param.mutable_quantization_param()->set_fl_layer_in(this->fl_layer_in_);
  hidden_param.mutable_quantization_param()->set_bw_layer_in(this->bw_layer_in_);
  hidden_param.mutable_quantization_param()->set_fl_layer_out(this->fl_layer_out_);
  hidden_param.mutable_quantization_param()->set_bw_layer_out(this->bw_layer_out_);
  ...
  for (int t = 1; t <= this->T_; ++t) {
    ...
    //         h_t := o_t .* \tanh[c_t]
    {
      ...
      lstm_unit_param->set_type("LSTMRistrettoUnit");
      ...
      lstm_unit_param->set_name("unit_" + ts);
        ...
        lstm_unit_param->mutable_quantization_param()->set_fl_params(this->fl_params_);
        lstm_unit_param->mutable_quantization_param()->set_bw_params(this->bw_params_);
        lstm_unit_param->mutable_quantization_param()->set_fl_layer_in(this->fl_layer_in_);
        lstm_unit_param->mutable_quantization_param()->set_bw_layer_in(this->bw_layer_in_);
        lstm_unit_param->mutable_quantization_param()->set_fl_layer_out(this->fl_layer_out_);
        lstm_unit_param->mutable_quantization_param()->set_bw_layer_out(this->bw_layer_out_);
    }
