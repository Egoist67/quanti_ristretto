...
#include "caffe/test/test_caffe_main.hpp"//added

namespace caffe {

// template <typename Dtype>
// Net<Dtype>::Net(const NetParameter& param)
// : root_net_(NULL){   //important
//   Init(param);
// }
...
// template <typename Dtype>
// //Net<Dtype>::Net(const string& param_file, Phase phase,//added
// //    const int level, const vector<string>* stages,//added
// //    const Net* root_net)//added
// //    : root_net_(root_net) {//added
// Net<Dtype>::Net(const string& param_file, Phase phase,//src
//     const int level, const vector<string>* stages)//src
//     : root_net_(NULL){   //important//src
//   NetParameter param;
...
void Net<Dtype>::Init(const NetParameter& in_param) {
   // CHECK(Caffe::root_solver() || root_net_)
      // << "root_net_ needs to be set for all non-root solvers";//added
...
/*#else
  ...
  for (int layer_id = 0; layer_id < param.layer_size(); ++layer_id) {
    ...
    bool share_from_root = !Caffe::root_solver()
        && root_net_->layers_[layer_id]->ShareInParallel();//added
    ...
    //layers_.push_back(LayerRegistry<Dtype>::CreateLayer(layer_param));//src
    ...
    //layers_[layer_id]->SetUp(bottom_vecs_[layer_id], top_vecs_[layer_id]);//src
