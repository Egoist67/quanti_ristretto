...
class Net {
 public:
  // explicit Net(const NetParameter& param);//src
  //explicit Net(const NetParameter& param, const Net* root_net);//src
  explicit Net(const NetParameter& param, const Net* root_net = NULL);//added
  explicit Net(const string& param_file, Phase phase,
      const int level = 0, const vector<string>* stages = NULL,
      const Net* root_net = NULL);//added
  // explicit Net(const string& param_file, Phase phase,
  //     const int level = 0, const vector<string>* stages = NULL);//src
  virtual ~Net() {}
