...
void EncodeBBox(const NormalizedBBox& prior_bbox,
    ...
    NormalizedBBox* encode_bbox, AnnotatedDatum_AnnotationType annotation_type);
...
void DecodeBBox(const NormalizedBBox& prior_bbox,
    ...
    const NormalizedBBox& bbox, NormalizedBBox* decode_bbox, AnnotatedDatum_AnnotationType annotation_type);
...
void EncodeLocPrediction(const vector<LabelBBox>& all_loc_preds,
      ...
      Dtype* loc1_pred_data, Dtype* loc1_gt_data,AnnotatedDatum_AnnotationType annotation_type);
...
void GetDetectionResults(const Dtype* det_data, const int num_det,
      ...
      map<int, LabelBBox>* all_detections, AnnotatedDatum_AnnotationType annotation_type);
