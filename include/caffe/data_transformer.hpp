...
#include "google/protobuf/repeated_field.h"//added

#include "caffe/blob.hpp"
#include "caffe/common.hpp"
#include "caffe/proto/caffe.pb.h"

using google::protobuf::RepeatedPtrField;//added
...
class DataTransformer {
 public:
   ...
   */
   void Transform(const cv::Mat& cv_img, Blob<Dtype>* transformed_blob,
                 NormalizedBBox* crop_bbox, bool* do_mirror);//added
  void Transform(const cv::Mat& cv_img, Blob<Dtype>* transformed_blob);
 ...
 protected:
  ...
  void Transform(const Datum& datum, Dtype* transformed_data);//added
