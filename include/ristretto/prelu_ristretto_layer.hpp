#ifndef CAFFE_PRELU_RISTRETTO_LAYER_HPP_
#define CAFFE_PRELU_RISTRETTO_LAYER_HPP_
...
class PReLURistrettoLayer : public PReLULayer<Dtype>, public BaseRistrettoLayer<Dtype> {
 public:
  explicit PReLURistrettoLayer(const LayerParameter& param);
      // :PReLULayer<Dtype>(param) {}
 ...
 protected:
  ...
  vector<shared_ptr<Blob<Dtype> > >  slope_quantized_;    
};
