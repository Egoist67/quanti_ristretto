...
ifeq ($(DEBUG), 1)
	...
	COMMON_FLAGS += -DNDEBUG -O2 -std=c++11 # cat changed -O2 to -O0 to prevent optimizing
endif
...
CXXFLAGS += -pthread -fPIC $(COMMON_FLAGS) $(WARNINGS)  # cat inserted nasty -g here. Remove it.
