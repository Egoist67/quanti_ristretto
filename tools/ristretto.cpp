...
DEFINE_string(weights, "",
    "The trained weights.");
DEFINE_string(qt_script_name, "",
    "The qt_script_name.");
DEFINE_string(PerAccuracy, "",
    "The per accuracy");
DEFINE_string(AllAccuracy, "",
    "The all accuracy");
...
int quantize(){
  ...
  Quantization* q = new Quantization(FLAGS_model,FLAGS_model_quantized,FLAGS_qt_script_name,
    FLAGS_PerAccuracy, FLAGS_AllAccuracy, FLAGS_trimming_mode,FLAGS_gpu);
  q->QuantizeNet();
  delete q;
  return 0;
}
