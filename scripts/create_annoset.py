...
if __name__ == "__main__":
  ...
  parser.add_argument("--anno-type", default = "classification",
      help="The type of annotation {classification, detection_fourpoints, detection_bbox,detection_offset_pretrain,detection_offset_finetuning}.")
  ...
  with open(list_file, "r") as lf:
    for line in lf.readlines():
      ...
      elif anno_type == "detection_fourpoints" or anno_type == "detection_bbox" or anno_type == "detection_offset_pretrain" or anno_type == "detection_offset_finetuning":
  ...
  if anno_type == "detection_fourpoints" or anno_type == "detection_bbox" or anno_type == "detection_offset_pretrain" or anno_type == "detection_offset_finetuning":
